...
public class CHIGameLogic : MonoBehaviour {
	...
	void Start() {
		...
		extController = extGameObject.GetComponent<CHIStackController>();
...
//		objControlledSharp.AddComponent<CHIHandleCollision> (); // Add the HandleCollision script to the objControlledSharp
